...
public class CusTagFlowLayout extends FlowLayout implements CusTagAdapter.OnDataChangedListener
{
    private CusTagAdapter mTagAdapter;
    ...
    public CusTagFlowLayout(Context context, AttributeSet attrs, int defStyle)
    {
    ...
    public CusTagFlowLayout(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public CusTagFlowLayout(Context context)
    {
        this(context, null);
    }
    ...
    public void setAdapter(CusTagAdapter adapter)
    {
    ...
    {
        removeAllViews();
        CusTagAdapter adapter = mTagAdapter;
...
//            lp.rightMargin = clp.rightMargin;
            ...
            } else
            {
                ...
                lp.setMargins(dip2px(getContext(), 1),
                        dip2px(getContext(), 1),
                        dip2px(getContext(), 1),
                        dip2px(getContext(), 1));
    ...
    public CusTagAdapter getAdapter()
    {
        return mTagAdapter;
    }
