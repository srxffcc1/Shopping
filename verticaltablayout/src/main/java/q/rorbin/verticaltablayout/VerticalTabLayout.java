                ...
                public void run() {
                    ...
                    if (direction > 0) {
                        startAnime = ValueAnimator.ofFloat(mIndicatorBottomY, targetBottom)
                                .setDuration(animationEnable?100:0);
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(animationEnable?100:0);
                        ...
                        startAnime = ValueAnimator.ofFloat(mIndicatorTopY, targetTop).setDuration(animationEnable?100:0);
                        startAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                                mIndicatorTopY = Float.parseFloat(animation.getAnimatedValue().toString());
                        ...
                        endAnime = ValueAnimator.ofFloat(mIndicatorBottomY, targetBottom).setDuration(animationEnable?100:0);
                        endAnime.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                            @Override
                            public void onAnimationUpdate(ValueAnimator animation) {
                                mIndicatorBottomY = Float.parseFloat(animation.getAnimatedValue().toString());
